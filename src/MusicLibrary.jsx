      ...
      <div className="music-container">
        ...
        <div>
          <ul className="billboard-List">
            <Artist
              artistPhoto="/assets/Artists/Metallica.png"
              artistName="Metallica"
              artistAlbum="Master"
              time="3:22"
            />
            <Artist
              artistPhoto="/assets/Artists/AJR.png"
              artistName="AJR"
              artistAlbum="Weak"
              time="3:22"
            />
            <Artist
              artistPhoto="/assets/Artists/Maclemore.png"
              artistName="Maclemore & Ryan Lewis"
              artistAlbum="The Heist"
            />
            <Artist
              artistPhoto="/assets/Artists/Nirvana.png"
              artistName="Nirvana"
              artistAlbum="Come"
            />
            <Artist
              artistPhoto="/assets/Artists/The beatles.png"
      ...
      <div className="player">
        <div className="popularsongs">
          ...
          <ul className="player-List">
            <PlayerList
              number="01"
              PlayerListPhoto="/assets/Song/EmptynesMachine.png"
            ...
            <PlayerList
              number="01"
              PlayerListPhoto="/assets/Song/letItBe.png"
            ...
            <PlayerList
              number="01"
              PlayerListPhoto="/assets/Song/MasterOfPuppets.png"
            ...
            <PlayerList
              number="01"
              PlayerListPhoto="/assets/Song/theHeist.png"
            ...
            <PlayerList
              number="01"
              PlayerListPhoto="/assets/Song/TheUnforgiven.png"
        ...
        <div className="playing">
          ...
          <ul className="monthlyArtist">
            <Monthly
              artist="/assets/Monthly/Brendon-Urie.webp"
              artistName="Bredon Urie"
            />
            <Monthly
              artist="/assets/Monthly/Edd.png"
              artistName="Edd Sheeran"
            />
            <Monthly artist="/assets/Monthly/Eminem.png" artistName="Eminem" />
            <Monthly
              artist="/assets/Monthly/fredy.png"
              artistName="Fredy Mercury"
            />
            <Monthly
              artist="/assets/Monthly/pitbull.png"
              artistName="Pitbull"
            />
          </ul>
          <div className="genres">
            ...
            <ul className="genresList">
              <Genres
                genreImage="/assets/Genres/HipHop.jpg"
                genreName="Hip-Hop"
              />
              <Genres genreImage="/assets/Genres/pop.jpg" genreName="Pop" />
              <Genres genreImage="/assets/Genres/Punk.jpg" genreName="Punk" />
              <Genres
                genreImage="/assets/Genres/reggae.jpg"
                genreName="Reggae"
              />
            </ul>
          </div>
